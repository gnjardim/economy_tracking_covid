...
```{r echo = FALSE, warning = FALSE, fig.width = 12, fig.height = 6.5}
comp_pib
```
\pagebreak
# Comparação entre Índice de Atividade Calculado com Mobilidade e com dados de energia:
