            ...
            tabsetPanel(type = "tabs",
                        tabPanel("Índices de Atividade",
                                 box(width = NULL, collapsible = TRUE, collapsed = FALSE,
                                     ...
                                     p('O eixo horizontal, comum a todos os gráficos, mostra o número de dias necessários para que o total de casos confirmados dobre. Quanto maior o tempo necessário (mais a direita no gráfico), mais devagar a doença está se difundindo.'),
