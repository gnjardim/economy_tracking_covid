            ...
            tabsetPanel(type = "tabs",
                        tabPanel("Índices de Atividade",
                                 box(width = NULL, collapsible = TRUE, collapsed = FALSE,
                                     ...
                                     p('- Para o gráfico de "Energia Total", o índice mostra a mudança percentual entre o consumo total de energia observado e o que foi projetado por um modelo contrafactual excluindo o efeito da Covid-19. Para mais detalhes, ver aba "Observado x Predito".'),
                                     p('- Para o gráfico de "Energia (apenas ACL)", o índice mostra a mudança percentual entre o consumo no ambiente livre de energia observado e o que foi projetado por um modelo contrafactual excluindo o efeito da Covid-19. Para mais detalhes, ver aba "Observado x Predito".'),
