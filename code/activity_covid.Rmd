...
## Testando a relação entre consumo de energia e o índice anterior
```{r echo = FALSE, warning = FALSE, message = FALSE}
regression <- dynlm(smth_activ ~ smth_consumo, data = energy_df) %>% 
    coef()

ggplot(energy_df, aes(x = smth_consumo, y = smth_activ)) +
    geom_point(color = "steelblue") +
    geom_abline(slope = regression[2], intercept = regression[1])
```


## Repetindo os gráficos  
